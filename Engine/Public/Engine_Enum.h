...
namespace Engine
{
    ...
    enum class CLOTHTYPE { SKIRT, CAPE, FEELER, END };
    ...
    enum class INTERACTIVE_TYPE {
        ...
        STATUE, VERTICALGATE, IRONGATE, UNLOCKGEAR, LARGEELEVATOR, GIANTGATE, DAPHRONA, DUIMUK, DANJIN, DANJINJAR, DESTINYSTONE, DESTRUCTIBLE,
        GACHANPC, ILLUSION_WALL, 
        END
    };
