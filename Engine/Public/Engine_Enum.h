...
namespace Engine
{
	...
	enum class RENDERGROUP { PRIORITY, SHADOW, STATIC, DYNAMIC, MOTIONVECTOR, OUTLINE, NONLIGHT, MOTIONTRAIL, BLEND, UI, END };
	...
	enum class INPUT_TYPE { GAMEPLAY, UI, POPUP, END };
	...
	enum class INTERACTIVE_TYPE { CHECKPOINT, CHEST, TOMBSTONE, TRIGGER, SPAWN, LADDER, ELEVATOR, LEVER, GEAR1, GEAR2, END };
}
