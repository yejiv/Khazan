...
HRESULT CModelMesh_Instance::Ready_Vertices_For_NonAnim(const aiMesh* pAIMesh, _fmatrix PreTransformMatrix)
{
...
HRESULT CModelMesh_Instance::Ready_Vertices_For_Anim(const aiMesh* pAIMesh, const vector<class CBone*>& Bones)
{
...
HRESULT CModelMesh_Instance::Ready_Indices_For_2Byte(const aiMesh* pAIMesh)
{
...
HRESULT CModelMesh_Instance::Ready_Indices_For_4Byte(const aiMesh* pAIMesh)
{
