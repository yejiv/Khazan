...
private:
	...
	const _char* m_strRenderGroupNames[11] = { "PRIORITY", "SHADOW","STATIC", "DYNAMIC","MOTIONVECTOR", "OUTLINE","NONLIGHT", "MOTIONTRAIL","WEIGHT_BLEND","BLEND", "UI"};
