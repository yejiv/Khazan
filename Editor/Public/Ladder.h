...
public:
    _float Get_TopPosition_Y();
    void Set_TopPosition_Y(_float fHeight);

    _float Get_MiddlePosition_Y();
    void Set_MiddlePosition_Y(_float fHeight);

private:
    class CLadder_Top* m_pTopObj = { nullptr };
    class CLadder_Middle* m_pMidObj = { nullptr };
    class CLadder_Bottom* m_pBotObj = { nullptr };

    CTransform* m_pTopObjTransform = { nullptr };
    CTransform* m_pMidObjTransform = { nullptr };
