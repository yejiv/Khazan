...
{
    GACHA_NPC_DESC* pDesc = static_cast<GACHA_NPC_DESC*>(pArg);
    ...
    CHECK_FAILED(CGameObject::Add_Component(ENUM_CLASS(eLevel), TEXT("Prototype_Component_Model_NPC_Danjin"),
