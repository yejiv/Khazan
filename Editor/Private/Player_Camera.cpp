...
CPlayer_Camera::CPlayer_Camera(const CPlayer_Camera& Prototype)
...
HRESULT CPlayer_Camera::Initialize_Clone(void* pArg)
{
    ...
    m_pGameInstance->Set_GizmoObject(this);
    return S_OK;
}

void CPlayer_Camera::Priority_Update(_float fTimeDelta)
{
    int a = 10;
}

void CPlayer_Camera::Update(_float fTimeDelta)
{
...
void CPlayer_Camera::Late_Update(_float fTimeDelta)
{
...
HRESULT CPlayer_Camera::Render_Shadow()
{
...
HRESULT CPlayer_Camera::Ready_Components()
{
    if (FAILED(CGameObject::Add_Component(ENUM_CLASS(LEVEL::STATIC), TEXT("Prototype_Component_Shader_VtxAnimMesh"),
        TEXT("Com_Shader"), reinterpret_cast<CComponent**>(&m_pShaderCom), nullptr)))
        return E_FAIL;

    if (FAILED(CGameObject::Add_Component(ENUM_CLASS(LEVEL::CAMERA), TEXT("Prototype_Component_Camera_Model_Test"),
...
HRESULT CPlayer_Camera::Bind_ShaderResources()
{
    if (FAILED(m_pTransformCom->Bind_Shader_Resource(m_pShaderCom, "g_WorldMatrix")))
        return E_FAIL;
...
CPlayer_Camera* CPlayer_Camera::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    ...
    {
        MSG_BOX(TEXT("Failed to Create : CPlayer_Camera"));
...
CGameObject* CPlayer_Camera::Clone(void* pArg)
{
    ...
    {
        MSG_BOX(TEXT("Failed to Clone : CPlayer_Camera"));
        Safe_Release(pInstance);
    }
