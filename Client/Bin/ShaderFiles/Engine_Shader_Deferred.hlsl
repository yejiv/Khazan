...
PS_OUT_BACKBUFFER PS_LUT(PS_IN In)
{
    ...
    if (true == g_isEnableLUT)
    {
        ...
        // ÇÈ¼¿ ÁÂÇ¥ -> Á¤±ÔÈ­µÈ UV ÁÂÇ¥·Î º¯È¯ (ÅØ¼¿ Áß¾Ó ¸ÂÃã)
...
PS_OUT_BACKBUFFER PS_MOTION_BLUR(PS_IN In)
{
    ...
    // ¸ð¼Ç º¤ÅÍ ±æÀÌ °è»ê ¹× ÀÓ°è°ª ¼³Á¤ (ÇöÀç Dynamic ±â·Ï ¾È µÇ´Â ¹®Á¦·Î ÀÓ½Ã ¿¹¿Ü Ã³¸®)
