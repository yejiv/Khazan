...
CLantern_Khazan_Spear::CLantern_Khazan_Spear(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    : CPartObject{ pDevice, pContext }
{
}

CLantern_Khazan_Spear::CLantern_Khazan_Spear(const CLantern_Khazan_Spear& Prototype)
    : CPartObject{ Prototype }
{
}

HRESULT CLantern_Khazan_Spear::Initialize_Prototype()
{
    return S_OK;
}

HRESULT CLantern_Khazan_Spear::Initialize_Clone(void* pArg)
{
...
void CLantern_Khazan_Spear::Priority_Update(_float fTimeDelta)
{
    if (!m_isEnble)
        return;
}

void CLantern_Khazan_Spear::Update(_float fTimeDelta)
{
    if (!m_isEnble)
        return;
...
HRESULT CLantern_Khazan_Spear::Render()
{
...
void CLantern_Khazan_Spear::Set_Equipped(bool equip)
{
    if (equip)
    {
...
HRESULT CLantern_Khazan_Spear::Ready_Components()
{
...
HRESULT CLantern_Khazan_Spear::Bind_ShaderResources()
{
...
CLantern_Khazan_Spear* CLantern_Khazan_Spear::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CLantern_Khazan_Spear* pInstance = new CLantern_Khazan_Spear(pDevice, pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_BOX(TEXT("Failed to Created : CLantern_Khazan_Spear"));
...
CGameObject* CLantern_Khazan_Spear::Clone(void* pArg)
{
    CLantern_Khazan_Spear* pInstance = new CLantern_Khazan_Spear(*this);

    if (FAILED(pInstance->Initialize_Clone(pArg)))
    {
        MSG_BOX(TEXT("Failed to Clone : CLantern_Khazan_Spear"));
        Safe_Release(pInstance);
    }
...
void CLantern_Khazan_Spear::Free()
{
    __super::Free();
