...
void CJar_8th::Animation_Update(_float fTimeDelta)
{
    ...
    case STEP6:
    {
        ...
        LightDesc.Callback = [&]() { m_pGameInstance->Set_LightEnable(TEXT("DanjinJar_8"), ENUM_CLASS(LEVEL::EMBARS), false); };
        m_pGameInstance->Start_LightTransition(TEXT("DanjinJar_8"), ENUM_CLASS(LEVEL::EMBARS), LightDesc);
        break;
    }
    case STEP7:
...
void CJar_8th::Animation_Change(_float fTimeDelta)
{
    ...
    case ANIM_STATE::DEACTIVE:
        ...
        m_pGameInstance->Set_LightEnable(TEXT("DanjinJar_8"), ENUM_CLASS(LEVEL::EMBARS), false);
        break;
    }
}
