...
CAS_P2_HandStomp_Viper::CAS_P2_HandStomp_Viper()
{

}

void CAS_P2_HandStomp_Viper::Enter(CStateMachine* pFSM, CGameObject* pOwner)
{
...
void CAS_P2_HandStomp_Viper::Exit(CStateMachine* pFSM, CGameObject* pOwner)
{
}
...
void CAS_P2_HandStomp_Viper::Free()
{
    __super::Free();
}
