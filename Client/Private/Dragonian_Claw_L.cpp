...
HRESULT CDragonian_Claw_L::Initialize_Prototype(_int iLevel)
{
...
void CDragonian_Claw_L::Priority_Update(_float fTimeDelta)
{
}
...
void CDragonian_Claw_L::Collision_Enter(COLLISION_DESC* pDesc, _uint iOtherObjectLayer, _float3 vContactPoint, _float3 ContactNormal)
{
...
void CDragonian_Claw_L::Collision_Stay(COLLISION_DESC* pDesc, _uint iOtherObjectLayer, _float3 vContactPoint, _float3 ContactNormal)
{
}

void CDragonian_Claw_L::Collision_Exit(COLLISION_DESC* pDesc, _uint iOtherObjectLayer)
{
}
...
CDragonian_Claw_L* CDragonian_Claw_L::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, _int iLevel)
{
    ...
    if (FAILED(pInstance->Initialize_Prototype(iLevel)))
    {
        ...
        MSG_BOX(TEXT("Failed Create : CDragonian_Claw_L"));
    }
    return pInstance;
}

CGameObject* CDragonian_Claw_L::Clone(void* pArg)
{
    CDragonian_Claw_L* pInstance = new CDragonian_Claw_L(*this);
    if (FAILED(pInstance->Initialize_Clone(pArg)))
    {
        Safe_Release(pInstance);
        MSG_BOX(TEXT("Failed Clone : CDragonian_Claw_L"));
    }

    return pInstance;
}

void CDragonian_Claw_L::Free()
{
    __super::Free();
