...
HRESULT CLevel_Loading::Ready_ObjectLayer()
{
    ...
    m_pGameInstance->Set_ObjectToBP(ENUM_CLASS(COLLISION_LAYER::PLAYER_TRIGGER), ENUM_CLASS(JOLT_BP_LAYER::TRIGGER));
    ...
    m_pGameInstance->Set_ObjectVsBPFilter(ENUM_CLASS(COLLISION_LAYER::PLAYER_TRIGGER), ENUM_CLASS(JOLT_BP_LAYER::NON_MOVING));
    ...
    m_pGameInstance->Set_ObjectFilter(ENUM_CLASS(COLLISION_LAYER::PLAYER_TRIGGER), ENUM_CLASS(COLLISION_LAYER::MAP_STATIC));
