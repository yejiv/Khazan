...
CJar_5th::CJar_5th(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    : CDanjinJar { pDevice, pContext }
{
}

CJar_5th::CJar_5th(const CJar_5th& Prototype)
    : CDanjinJar { Prototype }
{
}

HRESULT CJar_5th::Initialize_Prototype()
{
...
HRESULT CJar_5th::Initialize_Clone(void* pArg)
{
...
void CJar_5th::Priority_Update(_float fTimeDelta)
{
    Find_Target();
}

void CJar_5th::Update(_float fTimeDelta)
{
    ...
    m_pGameInstance->Set_LightPosition(TEXT("DanjinJar_5"), ENUM_CLASS(LEVEL::EMBARS), vPosition);
}

void CJar_5th::Late_Update(_float fTimeDelta)
{
    m_pGameInstance->Add_RenderGroup(RENDERGROUP::DYNAMIC, this);
}

HRESULT CJar_5th::Render()
{
    CHECK_FAILED_MSG(Bind_ShaderResources(), TEXT("CJar_5th : Bind_ShaderResources 함수 E_FAIL"), E_FAIL);
...
HRESULT CJar_5th::Ready_Components(void* pArg)
{
...
HRESULT CJar_5th::Ready_TalkUI(void* pArg)
{
    ...
    Desc.szName = "DanjinJar_5th_TalkUI";
...
HRESULT CJar_5th::Bind_Materials(_uint iMeshIndex)
{
    m_iMtrlFlags = 0;
...
void CJar_5th::Animation_Update(_float fTimeDelta)
{
...
void CJar_5th::Animation_Change(_float fTimeDelta)
{
    switch (m_eAnimState)
    {
...
void CJar_5th::Update_Step(_float fTimeDelta)
{
...
_float4 CJar_5th::Get_NextStepPos()
{
...
void CJar_5th::Collision_Enter(COLLISION_DESC* pDesc, _uint iOtherObjectLayer, _float3 vContactPoint, _float3 ContactNormal, COLLISION_DESC* pMyDesc)
{
...
void CJar_5th::Collision_Stay(COLLISION_DESC* pDesc, _uint iOtherObjectLayer, _float3 vContactPoint, _float3 ContactNormal, COLLISION_DESC* pMyDesc)
{
    if (iOtherObjectLayer == ENUM_CLASS(COLLISION_LAYER::CAMERA) || iOtherObjectLayer == ENUM_CLASS(COLLISION_LAYER::MONSTER))
        return;
...
void CJar_5th::Collision_Exit(COLLISION_DESC* pDesc, _uint iOtherObjectLayer, COLLISION_DESC* pMyDesc)
{
    if (iOtherObjectLayer == ENUM_CLASS(COLLISION_LAYER::CAMERA) || iOtherObjectLayer == ENUM_CLASS(COLLISION_LAYER::MONSTER))
        return;
...
CJar_5th* CJar_5th::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CJar_5th* pInstance = new CJar_5th(pDevice, pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_BOX(TEXT("Failed To Created : CJar_5th"));
...
CGameObject* CJar_5th::Clone(void* pArg)
{
    CJar_5th* pInstance = new CJar_5th(*this);

    if (FAILED(pInstance->Initialize_Clone(pArg)))
    {
        MSG_BOX(TEXT("Failed To Cloned : CJar_5th"));
        Safe_Release(pInstance);
    }
