...
HRESULT CJar_3rd::Initialize_Prototype()
{
...
HRESULT CJar_3rd::Initialize_Clone(void* pArg)
{
...
HRESULT CJar_3rd::Render()
{
    CHECK_FAILED_MSG(Bind_ShaderResources(), TEXT("CJar_3rd : Bind_ShaderResources 함수 E_FAIL"), E_FAIL);
...
HRESULT CJar_3rd::Ready_Components(void* pArg)
{
...
HRESULT CJar_3rd::Ready_TalkUI(void* pArg)
{
    ...
    Desc.szName = "DanjinJar_3rd_TalkUI";
...
HRESULT CJar_3rd::Bind_Materials(_uint iMeshIndex)
{
    m_iMtrlFlags = 0;
...
void CJar_3rd::Update_Step(_float fTimeDelta)
{
...
_float4 CJar_3rd::Get_NextStepPos()
{
...
void CJar_3rd::Collision_Enter(COLLISION_DESC* pDesc, _uint iOtherObjectLayer, _float3 vContactPoint, _float3 ContactNormal, COLLISION_DESC* pMyDesc)
{
...
void CJar_3rd::Collision_Stay(COLLISION_DESC* pDesc, _uint iOtherObjectLayer, _float3 vContactPoint, _float3 ContactNormal, COLLISION_DESC* pMyDesc)
{
    if (iOtherObjectLayer == ENUM_CLASS(COLLISION_LAYER::CAMERA) || iOtherObjectLayer == ENUM_CLASS(COLLISION_LAYER::MONSTER))
        return;
...
CJar_3rd* CJar_3rd::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CJar_3rd* pInstance = new CJar_3rd(pDevice, pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_BOX(TEXT("Failed To Created : CJar_3rd"));
...
CGameObject* CJar_3rd::Clone(void* pArg)
{
    CJar_3rd* pInstance = new CJar_3rd(*this);

    if (FAILED(pInstance->Initialize_Clone(pArg)))
    {
        MSG_BOX(TEXT("Failed To Cloned : CJar_3rd"));
        Safe_Release(pInstance);
    }
