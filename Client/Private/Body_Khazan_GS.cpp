...
HRESULT CBody_Khazan_GS::Ready_AnimationEvent_SFX()
{
    ...
    /* Attack */
    Register_EventGroup("SFX_Attack_Gs_Weak1", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_WEAK1, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Weak1_Impact", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_WEAK1_IMPACT, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Weak2", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_WEAK2, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Weak3", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_WEAK3, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Weak3_Impact", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_WEAK3_IMPACT, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Weak3_Foley", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_WEAK3_FOLEY, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Weak1_Charging", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_WEAK1_CHARGING, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Weak1_Charging_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_WEAK1_CHARGING_ATTACK, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Weak2_Charging", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_WEAK2_CHARGING, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Weak2_Charging_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_WEAK2_CHARGING_ATTACK, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Strong", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_STRONG, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Strong_Charging", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_STRONG_CHARGING, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Strong_Charging_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_STRONG_CHARGING_ATTACK, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Dodge_Charging", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_DODGE_CHARGING, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Dodge_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_DODGE_ATTACK, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Dodge_Impact", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_DODGE_IMPACT, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Brutal_Start", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_BRUTAL_START, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Brutal1", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_BRUTAL1, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Brutal2", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_BRUTAL2, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Attack_Gs_Fall", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::ATTACK_GS_FALL, 1.4f, SOUND_CHANNEL::WEAPON);

    /* Skill */
    Register_EventGroup("SFX_Skill_Gs_Breathtaking_Charging", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_BREATHTAKING_CHARGING, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Breathtaking_Start", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_BREATHTAKING_START, 1.4f, SOUND_CHANNEL::EFFECT1);
    Register_EventGroup("SFX_Skill_Gs_Breathtaking_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_BREATHTAKING_ATTACK, 1.4f, SOUND_CHANNEL::WEAPON); 
    Register_EventGroup("SFX_Skill_Gs_Breathtaking_Success", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_BREATHTAKING_SUCCESS, 1.4f, SOUND_CHANNEL::EFFECT2);
    Register_EventGroup("SFX_Skill_Gs_Breathtaking_Bloodshed_Charging", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_BREATHTAKING_BLOODSHED_CHARGING, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Breathtaking_Bloodshed_Charging_Success", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_BREATHTAKING_BLOODSHED_CHARGING_SUCCESS, 1.4f, SOUND_CHANNEL::EFFECT1);
    Register_EventGroup("SFX_Skill_Gs_Breathtaking_Bloodshed_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_BREATHTAKING_BLOODSHED_ATTACK, 1.4f, SOUND_CHANNEL::WEAPON); 
    Register_EventGroup("SFX_Skill_Gs_Breathtaking_Bloodshed_Success", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_BREATHTAKING_BLOODSHED_SUCCESS, 1.4f, SOUND_CHANNEL::EFFECT2);
    Register_EventGroup("SFX_Skill_Gs_Gianthunt_Charging", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_GIANTHUNT_CHARGING, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Gianthunt_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_GIANTHUNT_ATTACK, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Phantom_Shadowofdarkness_Charging", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_PHANTOM_SHADOWOFDARKNESS_CHARGING, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Phantom_Shadowofdarkness_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_PHANTOM_SHADOWOFDARKNESS_ATTACK, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Limit_Break_Charging", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_LIMIT_BREAK_CHARGING, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Limit_Break_Loop", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_LIMIT_BREAK_LOOP, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Limit_Break_Charging_FX", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_LIMIT_BREAK_CHARGING_FX, 1.4f, SOUND_CHANNEL::EFFECT1);
    Register_EventGroup("SFX_Skill_Gs_Limit_Break_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_LIMIT_BREAK_ATTACK, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Limit_Break_End", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_LIMIT_BREAK_END, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Break_Through_Charging", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_BREAK_THROUGH_CHARGING, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Break_Through_Run", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_BREAK_THROUGH_RUN, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Break_Through_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_BREAK_THROUGH_ATTACK, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Warcry_Charging", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_WARCRY_CHARGING, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Warcry_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_WARCRY_ATTACK, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Inner_Fury_Charging", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_INNER_FURY_CHARGING, 1.4f, SOUND_CHANNEL::WEAPON);
    Register_EventGroup("SFX_Skill_Gs_Inner_Fury_Charging_Success", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_INNER_FURY_CHARGING_SUCCESS, 1.4f, SOUND_CHANNEL::EFFECT1);
    Register_EventGroup("SFX_Skill_Gs_Inner_Fury_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::SKILL_GS_INNER_FURY_ATTACK, 1.4f, SOUND_CHANNEL::WEAPON);
    ...
    Register_EventGroup("_SFX_Attack_Gs_Weak1", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::VOICE_ATTACK_NORMAL, 1.f, SOUND_CHANNEL::VOICE);   /// N
    Register_EventGroup("_SFX_Attack_Gs_Weak2", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::VOICE_ATTACK_NORMAL, 1.f, SOUND_CHANNEL::VOICE);   /// N
    Register_EventGroup("_SFX_Attack_Gs_Weak3", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::VOICE_ATTACK_STRONG, 1.f, SOUND_CHANNEL::VOICE);   /// S
    Register_EventGroup("_SFX_Attack_Gs_Strong", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::VOICE_ATTACK_STRONG, 1.f, SOUND_CHANNEL::VOICE);  /// S
    Register_EventGroup("_SFX_Attack_Gs_Weak1_Charging_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::VOICE_ATTACK_STRONG, 1.f, SOUND_CHANNEL::VOICE);  /// S
    Register_EventGroup("_SFX_Attack_Gs_Weak2_Charging_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::VOICE_ATTACK_STRONG, 1.f, SOUND_CHANNEL::VOICE);  /// S
    Register_EventGroup("_SFX_Attack_Gs_Dodge_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::VOICE_ATTACK_MIDDLE, 1.f, SOUND_CHANNEL::VOICE);   ///M
    Register_EventGroup("_SFX_Attack_Gs_Brutal1", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::VOICE_ATTACK_MIDDLE, 1.f, SOUND_CHANNEL::VOICE);        ///  M
    Register_EventGroup("_SFX_Attack_Gs_Brutal2", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::VOICE_ATTACK_STRONG, 1.f, SOUND_CHANNEL::VOICE);        ///  S
    Register_EventGroup("_SFX_Skill_Gs_Breathtaking_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::VOICE_ATTACK_STRONG, 1.f, SOUND_CHANNEL::VOICE);     ///  S
    Register_EventGroup("_SFX_Skill_Gs_Breathtaking_Bloodshed_Attack", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::VOICE_ATTACK_STRONG, 1.f, SOUND_CHANNEL::VOICE); ///   S
    ...
    /* Damaged */
    Register_EventGroup("SFX_Damaged_Normal", 2, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::DAMAGED_NORMAL, 3.f, SOUND_CHANNEL::VOICE);
    Register_EventGroup("SFX_Damaged_Hard", 2, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::DAMAGED_HARD, 3.f, SOUND_CHANNEL::VOICE);

    /* Guard*/
    Register_EventGroup("SFX_Guard_On_Gs", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::GUARD_ON_GS, 7.f, SOUND_CHANNEL::EFFECT2);
    Register_EventGroup("SFX_Guard_Off_Gs", 1, ANIM_EVENT_TRIGGERTYPE::ENTER, SOUND_TYPE::GUARD_OFF_GS, 7.f, SOUND_CHANNEL::EFFECT2);
