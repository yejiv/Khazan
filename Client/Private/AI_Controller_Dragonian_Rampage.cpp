...
HRESULT CAI_Controller_Dragonian_Rampage::Initialize(CCreature* pOwner)
{
...
void CAI_Controller_Dragonian_Rampage::Update(CGameObject* pOwner, _float fTimeDelta)
{
    if (!m_isActive)
        return;
...
HRESULT CAI_Controller_Dragonian_Rampage::Ready_Perception(CGameObject* pOwner, const AIPERCEPTION_DATA& Desc)
{
...
HRESULT CAI_Controller_Dragonian_Rampage::Ready_BlackBoard(CGameObject* pOwner)
{
...
HRESULT CAI_Controller_Dragonian_Rampage::Ready_BehaviorTree()
{
    if (nullptr == m_pBB)
        return E_FAIL;
...
CONDITION CAI_Controller_Dragonian_Rampage::GetCallbackCondition(CGameObject* pOwner, const string& name)
{
    return nullptr;
}

ACTION CAI_Controller_Dragonian_Rampage::GetCallbackAction(CGameObject* pOwner, const string& name)
{
...
TERMINATE CAI_Controller_Dragonian_Rampage::GetCallbackTeminate(CGameObject* pOwner, const string& name)
{
    return nullptr;
}

INTERRUPTCONDITION CAI_Controller_Dragonian_Rampage::GetCallbackInterruptCondition(CGameObject* pOwner, const string& name)
{
    return nullptr;
}

PERCEPTIONCALLBACK CAI_Controller_Dragonian_Rampage::GetCallBackPerception(CGameObject* pOwner, const string& name)
{
    if (name == "Target")
    {
...
HRESULT CAI_Controller_Dragonian_Rampage::Ready_FSM(class CCreature* pOwner)
{
...
BTNODESTATE CAI_Controller_Dragonian_Rampage::Damage_Check(CGameObject* pOwner)
{
...
BTNODESTATE CAI_Controller_Dragonian_Rampage::Damage(CGameObject* pOwner)
{
...
BTNODESTATE CAI_Controller_Dragonian_Rampage::Turn_Check(CGameObject* pOwner)
{
...
BTNODESTATE CAI_Controller_Dragonian_Rampage::Turn(CGameObject* pOwner)
{
...
BTNODESTATE CAI_Controller_Dragonian_Rampage::Attack_Check(CGameObject* pOwner)
{
...
BTNODESTATE CAI_Controller_Dragonian_Rampage::LockOn(CGameObject* pOwner)
{
    if (!m_pMonData->isSleep)
    {
...
BTNODESTATE CAI_Controller_Dragonian_Rampage::Sleep(CGameObject* pOwner)
{
...
CAI_Controller_Dragonian_Rampage* CAI_Controller_Dragonian_Rampage::Create(CCreature* pOwner)
 {
    CAI_Controller_Dragonian_Rampage* pInstance = new CAI_Controller_Dragonian_Rampage();
    if (FAILED(pInstance->Initialize(pOwner)))
    {
        Safe_Release(pInstance);
        MSG_BOX(TEXT("Failed Create : CAI_Controller_Dragonian_Rampage"));
    }

    return pInstance;
}

void CAI_Controller_Dragonian_Rampage::Free()
{
    __super::Free();
}
