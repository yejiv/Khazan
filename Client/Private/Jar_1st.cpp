...
void CJar_1st::Update(_float fTimeDelta)
{
    ...
    m_pGameInstance->Set_LightPosition(TEXT("DanjinJar_1"), ENUM_CLASS(LEVEL::EMBARS), vPosition);
}
...
void CJar_1st::Animation_Update(_float fTimeDelta)
{
    ...
    case STEP16:
    {
        ...
        LightDesc.Callback = [&]() { m_pGameInstance->Set_LightEnable(TEXT("DanjinJar_1"), ENUM_CLASS(LEVEL::EMBARS), false); };
        m_pGameInstance->Start_LightTransition(TEXT("DanjinJar_1"), ENUM_CLASS(LEVEL::EMBARS), LightDesc);
        break;
    }
    }
}
