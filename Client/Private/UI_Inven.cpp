...
void CUI_Inven::Setting_Item()
{
    ...
    m_pEquipSlot[ENUM_CLASS(EQUIPSLOT_TYPE::WEAPON)]->Add_Item(4002, m_pItems[ENUM_CLASS(ITEMTYPE::GREATE)][0], false);
    ...
    m_pEquipSlot[ENUM_CLASS(EQUIPSLOT_TYPE::SHOES)]->Add_Item(5010, m_pItems[ENUM_CLASS(ITEMTYPE::SHOES)][0], false);
    ...
    m_pItems[ENUM_CLASS(ITEMTYPE::ATIVE)][1]->Add_Item(1003);
    //m_pItems[ENUM_CLASS(ITEMTYPE::ATIVE)][2]->Add_Item(1003);
    //m_pItems[ENUM_CLASS(ITEMTYPE::ATIVE)][3]->Add_Item(1004);
    m_pEquipSlot[ENUM_CLASS(EQUIPSLOT_TYPE::QUICK_1)]->Add_Item(1101, m_pItems[ENUM_CLASS(ITEMTYPE::ATIVE)][0], false);
    m_pEquipSlot[ENUM_CLASS(EQUIPSLOT_TYPE::QUICK_2)]->Add_Item(1003, m_pItems[ENUM_CLASS(ITEMTYPE::ATIVE)][1], false);
    //m_pEquipSlot[ENUM_CLASS(EQUIPSLOT_TYPE::QUICK_3)]->Add_Item(1003, m_pItems[ENUM_CLASS(ITEMTYPE::ATIVE)][2], false);
    //m_pEquipSlot[ENUM_CLASS(EQUIPSLOT_TYPE::QUICK_4)]->Add_Item(1004, m_pItems[ENUM_CLASS(ITEMTYPE::ATIVE)][3], false);
    //
    //수집품
