...
CAS_P2_DashUpper_Viper::CAS_P2_DashUpper_Viper()
{

}

void CAS_P2_DashUpper_Viper::Enter(CStateMachine* pFSM, CGameObject* pOwner)
{
...
void CAS_P2_DashUpper_Viper::Update(CStateMachine* pFSM, CGameObject* pOwner, _float fTimeDelta)
{
    CViper* pViper = static_cast<CViper*>(pOwner);
    CModel* pModel = static_cast<CModel*>(pViper->Get_P2Body()->Get_Component(TEXT("Com_Model")));
    ...
    if (pModel->Play_Animation(fTimeDelta))
    {
        ...
        pBB->Set_Value<_bool>(pViper->Get_Name(), "is_P2_DashUpperFinished", true);
    }
}
...
CAS_P2_DashUpper_Viper* CAS_P2_DashUpper_Viper::Create()
{
    return new CAS_P2_DashUpper_Viper();
}

void CAS_P2_DashUpper_Viper::Free()
{
    __super::Free();
}
