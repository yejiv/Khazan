...
namespace Client
{
	...
	enum class COLLISION_LAYER { MAP_STATIC, MAP_DYNAMIC, MAP_INTERACT, PLAYER, MONSTER, MONSTERATTACK ,ITEM, EFFECT, SKILL, CAMERA, END };
	...
	enum class DATATYPE { ITEM, EQUIPEFFECT, OTHEREFFECT, KHAZAN_SPEAR_ANIM, STATE, ANNOUNCE_TALK,END };
