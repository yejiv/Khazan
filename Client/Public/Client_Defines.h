...
namespace Client
{
	...
	enum class COLLISION_LAYER { MAP_STATIC, MAP_DYNAMIC, MAP_INTERACT, PLAYER, PLAYER_ATTACK, MONSTER, MONSTERATTACK ,ITEM, EFFECT, SKILL, CAMERA, MAP_STATIC_TRIGGER, MAP_MOVE_PLATFORM, END };
