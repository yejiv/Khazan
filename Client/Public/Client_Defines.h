...
namespace Client
{
	...
	enum class COLLISION_LAYER { MAP_STATIC, MAP_DYNAMIC, MAP_INTERACT, PLAYER, MONSTER, ITEM, EFFECT, SKILL, CAMERA, HAIR, END };

	enum class KHAZAN_MAP { HEINMACH, THECREVICE, EMBARS, VIPER, END };
