...
namespace Client
{
	...
	enum class COLLISION_LAYER { MAP_STATIC, MAP_DYNAMIC, MAP_INTERACT, PLAYER, PLAYER_ATTACK, PLAYER_SEARCH, MONSTER, MONSTERATTACK ,ITEM, EFFECT, SKILL, CAMERA, MAP_STATIC_TRIGGER, MAP_MOVE_PLATFORM, MAP_DEST, MAP_CHUNK, END };
	...
	enum class TEAM { NONE, PLAYER ,GOBLIN, YETI, BEAST ,END };
	...
	enum class HITREACTION { NONE, GROGGY, KNOCKBACK_WEAK, KNOCKBACK_NORMAL, KNOCKBACK_STRONG, PARRY, GRAB, GRAB_FINISHED, END };
