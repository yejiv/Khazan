...
namespace Client
{
	...
	enum class DATATYPE { ITEM, EQUIPEFFECT, OTHEREFFECT, KHAZAN_SPEAR_ANIM, STATE, ANNOUNCE_TALK, SKill, DANJINJAL, END };
    ...
    enum class MONSFX { NONE, REALIZE, MOVE, ATVO, SWISH, HITVO, DEAD, EFFECT1,EFFECT2,EFFECT3 ,END };
