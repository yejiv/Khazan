...
class CSequence_Embars_Puzzle_Third : public ISeqInstance
{
private:
    CSequence_Embars_Puzzle_Third();
    virtual ~CSequence_Embars_Puzzle_Third() = default;
...
public:
    static CSequence_Embars_Puzzle_Third* Create();
