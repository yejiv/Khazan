...
class CLevel_Training final : public CLevel
{
private:
    CLevel_Training(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    virtual ~CLevel_Training() = default;
...
public:
    static CLevel_Training* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
