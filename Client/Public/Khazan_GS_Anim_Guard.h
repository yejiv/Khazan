...
class CKhazan_GS_Anim_Guard : public CKhazan_Spear_Animation
{
private:
	CKhazan_GS_Anim_Guard();
	virtual ~CKhazan_GS_Anim_Guard() = default;
...
public:
	static CKhazan_GS_Anim_Guard* Create();
