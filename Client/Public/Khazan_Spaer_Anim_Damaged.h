...
class CKhazan_Spaer_Anim_Damaged final : public CKhazan_Spear_Animation
{
private:
    CKhazan_Spaer_Anim_Damaged();
    virtual ~CKhazan_Spaer_Anim_Damaged() = default;
...
public:
    static CKhazan_Spaer_Anim_Damaged* Create();
