...
class CDragonian_Claw_R final : public CWeaponObject
{
public:
...
private:
    CDragonian_Claw_R(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CDragonian_Claw_R(const CDragonian_Claw_R& Prototype);
    virtual ~CDragonian_Claw_R() = default;
