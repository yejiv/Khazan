...
class CAI_Controller_Elamain final : public CAI_Controller
{
private:
    CAI_Controller_Elamain();
    virtual ~CAI_Controller_Elamain() = default;
...
public:
    static CAI_Controller_Elamain* Create(class CCreature* pOwner);
