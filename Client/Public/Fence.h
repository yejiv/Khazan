...
class CFence final : public CProp_Destructible
{
public:
...
private:
    CFence(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
...
public:
    static CFence* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
