...
class CBody_Imp_Melee final : public CPartObject
{
public:
...
private:
    CBody_Imp_Melee(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CBody_Imp_Melee(const CBody_Imp_Melee& Prototype);
    virtual ~CBody_Imp_Melee() = default;
