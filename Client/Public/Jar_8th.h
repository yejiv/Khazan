...
class CJar_8th final : public CDanjinJar
{
private:
    enum STEP_STATE {
        STEP1,
...
private:
    CJar_8th(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CJar_8th(const CJar_8th& Prototype);
    virtual ~CJar_8th() = default;
...
public:
    static CJar_8th* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
