...
class CAI_Controller_Dragonian_Rampage final : public CAI_Controller
{
private:
    CAI_Controller_Dragonian_Rampage();
    virtual ~CAI_Controller_Dragonian_Rampage() = default;
...
private:
    ...
    BTNODESTATE                                 Attack_Jump(CGameObject* pOwner);
...
public:
    static CAI_Controller_Dragonian_Rampage*    Create(class CCreature* pOwner);
