...
class CJar_3rd final : public CDanjinJar
{
private:
    enum STEP_STATE {
        STEP1,
...
private:
    CJar_3rd(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CJar_3rd(const CJar_3rd& Prototype);
    virtual ~CJar_3rd() = default;
...
public:
    static CJar_3rd* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
