...
class CAI_Controller_Imp_Range final : public CAI_Controller
{
private:
    CAI_Controller_Imp_Range();
    virtual ~CAI_Controller_Imp_Range() = default;
...
public:
    static CAI_Controller_Imp_Range*    Create(class CCreature* pOwner);
