...
class CSpear_Khazan_Sample final : public CPartObject
{
public:
...
private:
	CSpear_Khazan_Sample(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CSpear_Khazan_Sample(const CSpear_Khazan_Sample& Prototype);
...
public:
	static CSpear_Khazan_Sample* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
