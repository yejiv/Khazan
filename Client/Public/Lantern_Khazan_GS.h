...
class CLantern_Khazan_GS final : public CPartObject
{
public:
...
private:
    CLantern_Khazan_GS(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CLantern_Khazan_GS(const CLantern_Khazan_GS& Prototype);
    virtual ~CLantern_Khazan_GS() = default;
...
public:
    static CLantern_Khazan_GS* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
