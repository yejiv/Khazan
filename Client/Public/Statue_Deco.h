...
class CStatue_Deco final : public CPartObject
{
public:
    typedef struct tagStatueDecoDesc : public CPartObject::PARTOBJECT_DESC
    {
...
public:
    static CStatue_Deco* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
